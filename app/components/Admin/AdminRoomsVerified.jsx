    ...
    DeleteRoom: function (RId) {
        ...
        swal({
            ...
            if (willDelete) {
                ...
                this.props.history.push("/AdminRoomsVerified");
            } else {
                                            ...
                                            <div className="col-sm-8 col-lg-7">
                                                <a>
                                                    ...
                                                    <form onClick={RoomMoreDetails}>
                                                        ...
                                                        <img src={rooms.Image_name} className="screenShot" id="colorPicker"
                                                             onClick={RoomMoreDetails.bind(this, rooms._id)}/>
                                                    </form>
                                                </a>
                            ...
                            return (
                                ...
                                <div id="leftProject" key={roomsMorDetails._id}>
                                    ...
                                    <p className="row projectBlurb" style={{textAlign: 'center'}}>
                                        Available On : <Time value={roomsMorDetails.Room_Availability_From}
                                                             format="DD/MM/YYYY"/>
                                        - Till :
                                    ...
                                    <div className="row projectInfo"
                                         style={{marginLeft: '50px', marginRight: '242px', fontSize: '15px'}}>
                                        <div className="col-sm-8 col-lg-7">
                                            <a target="_blank">
                                                <img src={roomsMorDetails.Image_name} className="screenShot"
                                                     id="colorPicker"/>
                                            </a>
                                        </div>
                                        <div className="col-sm-4 col-lg-5">
                                            <h5 className="projectSubTitle" style={{
                                                fontSize: '45px',
                                                marginBottom: '25px'
                                            }}>{roomsMorDetails.Room_Cost_in_euros} € </h5>
                                            <ul className="technologies" style={{marginRight: '-200px'}}>
                                                ...
                                                <li>Other Details :<p
                                                    style={{textAlign: 'justify'}}> {roomsMorDetails.Other_details}</p></li>
                                            </ul>
                                        </div>
                                    </div>
